...
find / -user work 搜索属于用户 'work' 的文件和目录
find /home/work -name \*.bin 在目录 '/home/work' 中搜索带有'.bin' 结尾的文件
...
tar -cvfz archive.tar.gz dir1 --exclude *.log --exclude *.out 排除多个目录或文件
